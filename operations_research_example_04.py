#! /usr/bin/env python3
"""
Udemy operations research course example 04
"""
...
def main():
    ...
    # constraints --> TIP:
    # run the code and print m.setRoutes_from and m.setRoutes_to,i
    # and check the SETs of the problem
    # you can replace m.setRoutes_from["A"] for "P1", "P2"],
    # it would work for this problem, but not for another network
    m.C1 = pyo.Constraint(
